/*
*This code outputs the binary equivalent of the key typed.
*It uses 7 frames, even parity, and 1 stop bit.
*It also outputs a frequency to a connected speaker
*based on which key is pressed.
*The frequency selected is arbitrary.
*
*Added code after "initUSART()" to enables rx and x pins
*set data bits, set parity bits, and stop bits
*
...
int main(void) {
	/*
	*Enables rx and tx, 7 data bits,even parity, 1 stop bit
	*/
	initUSART();
