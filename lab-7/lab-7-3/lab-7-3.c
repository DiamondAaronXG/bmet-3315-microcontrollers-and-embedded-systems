/*
*This code turns a servo motor to its minimum, maximum, and centre.
*It then waits for the user to input a number through serial and
*turns to the corresponding degree.
*
*Ajusted minimum, maximum, and centre values.
*
...
#define PULSE_MIN         0400         /* experiment with these values */
#define PULSE_MAX         2000              /* to match your own servo */
#define PULSE_MID         1000
