/*
*This code outputs a square wave base upon the value entered
*by the user through serial communication.
*This code will also echo back what it receives through serial com.
*
*Added code to echo back what is received.
*
