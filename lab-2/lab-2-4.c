/*
*This code causes the LED bar graph to all bars in a pttern from left to right
*then,all LEDs off from left to right and vice versa. After one cycle random
*LEDs are tuned on and off
*
*Changed DELAYTIME variable defined in line 20 to a value of "44"
...
#define DELAYTIME 44                                   /* milliseconds */
